#ifndef CALAMPSUSERMESSAGE_H
#define CALAMPSUSERMESSAGE_H
...
{
public:
	CalAmpsUserMessage(struct dev_data *, CALAMP_WAT_MESSAGE message);

	void				setSequenceNumber(qint16 );
