...
(
	MyData& pData, 
	const ats::String& p_packetizerdb_name, 
	const ats::String& p_packetizerdb_path
...
bool DB::copy(const ats::String& p_table, ats::StringMap &p_sm)
{
...
bool DB::dbload_messagetypes(std::map<int,int>& p_mt)
{
...
int DB::dbquery_SelectPriorityOneMessage()
{
	ats::String buf;
