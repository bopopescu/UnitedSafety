...
typedef enum {
	...
	TRAK_J1939_MSG =                 45,
	TRAK_J1939_FAULT_MSG =           46,
	TRAK_J1939_STATUS2_MSG =         47,
	TRAK_IRIDIUM_OVERLIMIT_MSG =     48,
	TRAK_SEATBELT_ON =               53,
	TRAK_SEATBELT_OFF =              54,
	TRAK_CRITICAL_BATTERY_MSG =      110,
	TRAK_INET_ERROR =                253,
	TRAK_INET_MSG =                  254,
	TRAK_TRULINK_MSG =               255,
	TRAK_CALAMP_USER_MSG =           256,
} TRAK_MESSAGE_TYPE;
