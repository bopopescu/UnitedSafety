...
#  set_val stage TEST2
  echo -e "msg ignition_on\r" | socat - unix-connect:/var/run/redstone/message-assembler
  sleep 5
  echo -e "msg ignition_off\r" | socat - unix-connect:/var/run/redstone/message-assembler
  sleep 5
  echo -e "msg ignition_on\r" | socat - unix-connect:/var/run/redstone/message-assembler
  ...
  echo -e "msg scheduled_message\r" | socat - unix-connect:/var/run/redstone/message-assembler
  wait_for_message_send                                                              
  ...
  # OK message (checkin)                                  
  echo -e "msg calamp_user_msg usr_msg_data=245047454D43492C2C2C2C2C534C502A3736 mobile_id=3781220525589678 mobile_id_type=4\r" | socat - unix-connect:/var/run/redstone/message-assembler
                                                                                        
  # SOS                                           
  echo -e "msg calamp_user_msg usr_msg_data=245047454D454D2C2C2C534C502A3734 mobile_id=3781220525589678 mobile_id_type=4\r" | socat - unix-connect:/var/run/redstone/message-assembler
                                                  
  # cancel emergency                      
  echo -e "msg calamp_user_msg usr_msg_data=245047454D45432C2C2C534C502A3741 mobile_id=3781220525589678 mobile_id_type=4\r" | socat - unix-connect:/var/run/redstone/message-assembler
                                                  
  # Stop monitoring                       
  echo -e "msg calamp_user_msg usr_msg_data=245047454D4D4F2C2C2C534C502A3745 mobile_id=3781220525589678 mobile_id_type=4\r" | socat - unix-connect:/var/run/redstone/message-assembler
  wait_for_message_send                                                              
  ...
  echo -e "msg calamp_user_msg 	usr_msg_data=$data1$data2\r" | socat - unix-connect:/var/run/redstone/message-assembler
  wait_for_message_send
  ...
  echo -e "msg calamp_user_msg 	usr_msg_data=$data\r" | socat - unix-connect:/var/run/redstone/message-assembler
  wait_for_message_send
  ...
  echo -e "msg ignition_on msg_priority=9\r" | socat - unix-connect:/var/run/redstone/message-assembler
  sleep 5
  echo -e "msg ignition_off msg_priority=9\r" | socat - unix-connect:/var/run/redstone/message-assembler
  sleep 5
  echo -e "msg ignition_on msg_priority=9\r" | socat - unix-connect:/var/run/redstone/message-assembler
  ...
  echo -e "msg scheduled_message msg_priority=9\r" | socat - unix-connect:/var/run/redstone/message-assembler
  wait_for_message_send                                                              
  ...
  # OK message (checkin)                                  
  echo -e "msg calamp_user_msg  msg_priority=9 usr_msg_data=245047454D43492C2C2C2C2C534C502A3736 mobile_id=3781220525589678 mobile_id_type=4\r" | socat - unix-connect:/var/run/redstone/message-assembler
                                                                                        
  # SOS                                           
  echo -e "msg calamp_user_msg  msg_priority=9 usr_msg_data=245047454D454D2C2C2C534C502A3734 mobile_id=3781220525589678 mobile_id_type=4\r" | socat - unix-connect:/var/run/redstone/message-assembler
                                                  
  # cancel emergency                      
  echo -e "msg calamp_user_msg  msg_priority=9 usr_msg_data=245047454D45432C2C2C534C502A3741 mobile_id=3781220525589678 mobile_id_type=4\r" | socat - unix-connect:/var/run/redstone/message-assembler
                                                  
  # Stop monitoring                       
  echo -e "msg calamp_user_msg  msg_priority=9 usr_msg_data=245047454D4D4F2C2C2C534C502A3745 mobile_id=3781220525589678 mobile_id_type=4\r" | socat - unix-connect:/var/run/redstone/message-assembler
  wait_for_message_send                                                              
  ...
  echo -e "msg heartbeat msg_priority=9\r" | socat - unix-connect:/var/run/redstone/message-assembler
  wait_for_message_send
  GetYNResponse "TEST8:" "Was a HEARTBEAT record received in CAMS?" "HEARTBEAT message (Iridium) were not received in CAMS"
  
  #Test 10 INPUTS
  echo -e "msg sensor msg_priority=9\r" | socat - unix-connect:/var/run/redstone/message-assembler
  echo -e "msg sensor msg_priority=9\r" | socat - unix-connect:/var/run/redstone/message-assembler
  wait_for_message_send
  ...
  echo -e "msg calamp_user_msg 	msg_priority=9 usr_msg_data=$data\r" | socat - unix-connect:/var/run/redstone/message-assembler
  wait_for_message_send
