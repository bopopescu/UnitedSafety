...
void drv_lcd_warning (void)
{
	WATCHDOG_RESET();

	lcd_puts("## WARNING: SYSTEM FAILURE ##\n");
	lcd_puts("## recovery in progress... ##\n");
	lcd_puts("##  DO NOT REMOVE POWER !  ##\n");
}

void drv_lcd_sys_error (void)
{
	WATCHDOG_RESET();

	lcd_puts("####  ERROR ERROR ERROR! ####\n");
	lcd_puts("## SYSTEM RECOVERY FAILURE ##\n");
	lcd_puts("# Email support@siconix.com #\n");
	lcd_puts("## or call +1(403)567-0708 ##\n");
}
