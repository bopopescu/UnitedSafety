...
/* AWARE360 FIXME: When did this change from 0x0681 to 0x1e2d? Gemalto
 *	should be able to answer this question since it is their vendor
 *	ID.
 */
#if 0
...
#define CINTERION_PRODUCT_PLxx			0x0060 /* Add QMI feature on Linux kernel 2.6 by Hiro */
...
/* Begin: Add QMI feature on Linux kernel 2.6 by Hiro */ 
static const u8 cinterion_ph8_reserved[] = {4};
static const struct option_blacklist_info cinterion_ph8_blacklist = {
	.infolen = ARRAY_SIZE(cinterion_ph8_reserved),
	.ifaceinfo = cinterion_ph8_reserved,
	.reason = OPTION_BLACKLIST_RESERVED_IF
};
static const u8 cinterion_plxx_reserved[] = {4};
static const struct option_blacklist_info cinterion_plxx_blacklist = {
	.infolen = ARRAY_SIZE(cinterion_plxx_reserved),
	.ifaceinfo = cinterion_plxx_reserved,
	.reason = OPTION_BLACKLIST_RESERVED_IF
};
/* End: Add QMI feature on Linux kernel 2.6 by Hiro */ 
...
static const struct usb_device_id option_ids[] = {
	...
	/* Begin: Mod QMI feature on Linux kernel 2.6 by Hiro */

	{ USB_DEVICE(CINTERION_VENDOR_ID, CINTERION_PRODUCT_PH8) }, // PH8
/*
	{ USB_DEVICE(CINTERION_VENDOR_ID, CINTERION_PRODUCT_PH8) ,
		.driver_info = (kernel_ulong_t)&cinterion_ph8_blacklist
	}, // PH8
*/
	{ USB_DEVICE(CINTERION_VENDOR_ID, CINTERION_PRODUCT_PLxx),
		.driver_info = (kernel_ulong_t)&cinterion_plxx_blacklist
	}, // PLxx},

	/* End: Mod QMI feature on Linux kernel 2.6 by Hiro */
			...
			const struct usb_device_id *id)
{
	...
	/* Don't bind blacklisted interfaces */
	if (is_blacklisted(ifNum, (const struct option_blacklist_info *) id->driver_info) == OPTION_BLACKLIST_RESERVED_IF) {
		return -ENODEV;
	}
