...
{
	printk(KERN_EMERG "\x1b[1;44;37mTRULink Powered Down\x1b[0m\n");
	gpio_direction_output(MXS_PIN_TO_GPIO(MXS_PIN_ENCODE(3, 12)), 1);
	/* It takes 500 milliseconds for the "CPU Off" signal to turn off the CPU. */
	msleep(500);
	printk(KERN_EMERG "\x1b[1;44;37mTRULink Power-Down Failed, CPU will restart...\x1b[0m\n");
