...
/* ATS RedStone: Bank 2, Pin 20 is EN_USB0 "Active high to turn on USB0 power (Host mode)"
 * Amour Hassan: Wednesday, August 21, 2013
 *
 * ATS FIXME: This same definition is defined in "./power.c". Why is this?
 *            This definition should be in a header file.
 */
#define USB_POWER_ENABLE MXS_PIN_TO_GPIO(MXS_PIN_ENCODE(2, 20))
...
#ifndef CONFIG_REDSTONE_DISABLE_USB_OTG_WAKEUP_IRQ
